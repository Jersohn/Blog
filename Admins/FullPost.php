  ...
  <div class="container">
    <div class="row mt-4">
      ...
      <div class="col-sm-8">
        ...
        while ($DataRows = $stmt->fetch()) {
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <small class="text-muted">Category :<a style="font-weight: bold;" class="text-dark">
        ...
        <?php } ?>
        <!-- Comment part start -->
        <span style="color:rgb(251, 174, 44);font-size: 1.2em ;">Comments</span>
        <br><br>
          ...
          <form action="FullPost.php?id=<?php echo $ParamID ?>" method="post">
            <div class="card mb-3">
              <div class="card-header">
                <h5 style="color:rgb(251, 174, 44);">Share your thoughts about this post</h5>
              </div>
              <div class="card-body">
